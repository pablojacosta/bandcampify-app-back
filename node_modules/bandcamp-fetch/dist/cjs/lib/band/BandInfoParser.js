...
class BandInfoParser {
    static parseInfo(html, opts) {
        ...
        try {
            ...
            throw new Parse_1.ParseError('Failed to parse artist / label info: JSON error in band data.', html, error);
        }
        ...
        if (bioText.length) {
            ...
            if (description) {
                description = (0, Parse_1.stripLineBreaks)(description);
                description = (0, Parse_1.brToNewLine)(description);
                description = (0, Parse_1.stripTags)(description);
        ...
        const imageUrl = (0, Parse_1.reformatImageUrl)($('img.band-photo').attr('src'), opts.imageFormat);
        if (imageUrl) {
