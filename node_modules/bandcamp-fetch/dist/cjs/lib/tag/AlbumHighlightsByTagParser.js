...
class AlbumHighlightsByTagParser {
    static parseHighlights(html, opts) {
        ...
        try {
            ...
            throw new Parse_1.ParseError('Failed to parse album highlights by tag: JSON error in data-blob', html, error);
        }
        const collections = [];
...
exports.default = AlbumHighlightsByTagParser;
