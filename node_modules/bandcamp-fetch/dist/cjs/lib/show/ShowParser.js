...
class ShowParser {
    static parseShow(html, opts) {
        ...
        try {
            ...
            throw new Parse_1.ParseError('Failed to parse show: JSON error in data-blob.', html, error);
        }
