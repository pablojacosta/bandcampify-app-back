...
import { CacheDataType } from './lib/utils/Cache';
...
export declare class Cache {
    static clear(type?: CacheDataType): void;
    static setTTL(type: CacheDataType, ttl: number): void;
    static setMaxPages(maxPages: number): void;
}
declare const _default: {
    ...
    limiter: {
        album: typeof LimiterAlbumAPI;
        track: typeof LimiterTrackAPI;
        discovery: typeof LimiterDiscoveryAPI;
        image: typeof LimiterImageAPI;
        band: typeof LimiterBandAPI;
        tag: typeof LimiterTagAPI;
        article: typeof LimiterArticleAPI;
        show: typeof LimiterShowAPI;
        fan: typeof LimiterFanAPI;
        search: typeof LimiterSearchAPI;
        autocomplete: typeof LimiterAutocompleteAPI;
        updateSettings: typeof Limiter.updateSettings;
    };
    cache: typeof Cache;
};
