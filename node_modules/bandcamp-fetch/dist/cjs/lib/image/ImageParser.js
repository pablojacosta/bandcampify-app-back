...
class ImageParser {
    static parseImageConstants(html) {
        ...
        try {
            ...
            throw new Parse_1.ParseError('Failed to parse image constants: JSON error.', vars, error);
        }
        ...
        throw new Parse_1.ParseError('Failed to parse image constants: data is missing \'client_template_globals\' field.', parsed);
    }
}
